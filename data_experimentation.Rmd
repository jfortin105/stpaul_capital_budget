...
g_med <- Adopted_Capital_Improvement_Budgets %>% 
  ...
  geom_col(fill = "#FDB462") +
  scale_y_continuous(labels = scales::dollar) +
  labs(title = "Yearly Median Adopted Capital Improvement Budgets",
       subtitle = "2004 - 2021",
       y = "",
       x = "") +
  theme(plot.title.position = "plot",
...
g_mean <- Adopted_Capital_Improvement_Budgets %>% 
  ...
  geom_col(fill = "#FDB462") +
  scale_y_continuous(labels = scales::dollar) +
  labs(title = "Yearly Mean Adopted Capital Improvement Budgets",
       subtitle = "2004 - 2021",
       y = "",
       x = "") +
  theme(plot.title.position = "plot",
...
g_yearly_counts <- Adopted_Capital_Improvement_Budgets %>% 
  ...
  geom_col(fill = "#FDB462") +
  labs(title = "Amount of Adopted Capital Improvement Projects per Year",
       subtitle = "2004 - 2021",
       y = "",
       x = "") +
  theme(plot.title.position = "plot",
